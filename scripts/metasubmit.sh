...
#PBS -o /home/hsher/meta.out
#PBS -e /home/hsher/meta.err
#PBS -t 1-102
...
python /home/hsher/project5/ClipNet/ReadDensity/run_indv_quantile_scale_metadensity.py $uid ~/seqdata/indv_quantile_metadensity
