...
#PBS -o /home/hsher/cluster_msg/g4hunt.out
#PBS -e /home/hsher/cluster_msg/g4hunt.err
#PBS -t 0-1

source ~/miniconda3/etc/profile.d/conda.sh
conda activate g4_hunter
...
dir=/home/hsher/projects/RG4/

#files=(unmod_rep1.fasta unmod_rep2.fasta unmod_rep1_mcherry.fasta unmod_rep2_mcherry.fasta)
files=(gencode.v33.UTR.fasta)
...
python /home/hsher/bin/G4Hunter/G4Hunter.py -i $dir$file -o $dir -w 30 -s 2 
